    ...
    <>
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">
          Track every ingredient, spot low stock early, and sync scans into your inventory log.
        </p>
      </div>
      ...
      <div className="grid gap-4 lg:grid-cols-[2fr,1fr]">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update counts manually or use automated scans.
            </CardDescription>
          </CardHeader>
        ...
        <div className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Use automated functions to scan shelves and log inventory updates.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="rounded-lg border bg-muted/40 p-4 text-sm space-y-2">
                ...
                <ul className="list-disc list-inside text-muted-foreground space-y-1">
                  <li>Create a scan function named <span className="font-mono">scanInventory</span>.</li>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest updates captured by automated scans.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {scanLog.map((scan) => (
